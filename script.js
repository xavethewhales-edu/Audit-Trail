...
const scenes = {
  ...
  // =========================================================
  // WEEK 1 — BENIDORM: WHEN A GOOD STORY MEETS THE EVIDENCE
  // C1 HEAD AUDITOR
  // =========================================================


  // ---------------------------------------------------------
  // SCENE 1 — OPENING CONVERSATION
  // ---------------------------------------------------------

  scene1: {
    type: "text",
    text: `
Benidorm is an unusual real-estate story.

In little more than a generation, a relatively small coastal town became one
of Europe's most concentrated high-rise tourism markets.

Before looking at the numbers, consider the story itself.

A colleague says:

"Whatever people think of Benidorm aesthetically, you have to admit that
the development model worked."

Which response would you be most inclined to make in a normal conversation?
    `,
    choices: [
      {
        text: "Yes. The scale of the growth makes that difficult to dispute.",
        next: "scene2"
      },
      {
        text: "Possibly, although I'd first want to define what we mean by 'worked'.",
        next: "scene2"
      },
      {
        text: "Financially perhaps, but that tells us very little about how resilient the model was.",
        next: "scene2"
      }
    ]
  },
  ...
  // ---------------------------------------------------------
  // SCENE 2 — VIDEO 1
  // DOCUMENTATION VS A GOOD STORY
  // ---------------------------------------------------------

  scene2: {
    type: "video-multi-question",
    youtube: "https://www.youtube.com/watch?v=5JrE1_K-m-s&t=345s",

    text: `
WATCH 5:45–6:16

The video pauses on one of Benidorm's most famous founding stories.

Listen especially to what happens when the narrator goes looking for
...
Then answer the questions.
    ...
    questions: [
      {
        text: "What is the central evidence problem described in this section?",
        options: [
          "The surviving documents directly contradict Zaragoza's version.",
          "Several important parts of the story cannot be independently documented.",
          "The municipal records were deliberately destroyed.",
          "The story was originally created by the tourism industry."
        ],
        correct: 1
      },
      {
        text: "From an audit perspective, what is the most defensible treatment of Zaragoza's later recollections?",
        options: [
          "Treat them as useful testimony, but seek corroborating evidence before presenting the details as established fact.",
          "Exclude them completely because personal recollection has no evidential value.",
          "Accept them because he was directly involved in the events.",
          "Treat them as documentary evidence unless somebody proves them wrong."
        ],
        correct: 0
      },
      {
        text: "Which statement best reflects the narrator's final position?",
        options: [
          "The entire story is probably false.",
          "The absence of paperwork proves the events never occurred.",
          "The precise legend may be uncertain even though the broader change it represents was real.",
          "The historical uncertainty is irrelevant because Benidorm ultimately succeeded."
        ],
        correct: 2
      }
    ],
  ...
  scene2_retry: {
    type: "text",
    text: `
The difficult part here is separating three things:

• what somebody remembers;
• what appears plausible;
• what can actually be supported.

An auditor does not necessarily reject the story.

The question is how confidently it can be stated.

Watch the short extract once more.
    `,
    choices: [
      {
        text: "Watch again",
  ...
  // ---------------------------------------------------------
  // SCENE 3 — CONVERSATIONAL BRIDGE
  // ---------------------------------------------------------

  scene3: {
    type: "text",
    text: `
That distinction appears everywhere in professional life.

A persuasive explanation may be:

• entirely accurate;
• broadly accurate but simplified;
• based on incomplete evidence;
• or simply repeated so often that nobody questions it anymore.

Now move from the story of Benidorm to the economics behind it.

A colleague comments:

"Whatever the mythology, the planning policy clearly caused Benidorm's
economic success."

That sounds plausible.

But is "caused" doing too much work?
    `,
    choices: [
      {
        text: "Look at the planning evidence",
        next: "scene4"
      }
    ]
  },
  ...
  scene4: {
    type: "video-multi-question",
    youtube: "https://www.youtube.com/watch?v=5JrE1_K-m-s&t=424s",

    text: `
WATCH 7:04–8:41

Focus on the 1956 development plan, the later change in planning rules,
the marketing strategy and the reference to the municipal ledgers.

The challenge is not remembering dates.

The challenge is deciding what the evidence allows us to conclude.
    `,
    ...
    questions: [
      {
        text: "What was unusual about the planning model?",
        options: [
          "It restricted the number of tourists allowed into the town.",
          "It prohibited development close to the beaches.",
          "It permitted height while requiring open space around buildings.",
          "It required developers to construct low-density resorts."
        ],
        correct: 2
      },
      {
        text: "The video links the planning model with Benidorm's later skyline. What should an auditor be careful about?",
        options: [
          "Assuming that a plausible sequence automatically establishes the full causal relationship.",
          "Using planning documents as evidence.",
          "Comparing development before and after a regulatory change.",
          "Considering unintended consequences of regulation."
        ],
        correct: 0
      },
      {
        text: "Which formulation is the most defensible?",
        options: [
          "The planning reform was solely responsible for Benidorm's prosperity.",
          "The planning reform appears to have been one important factor in enabling subsequent development.",
          "Benidorm grew despite the planning reform.",
          "The municipal budget proves that the planning policy was successful."
        ],
        correct: 1
      },
      {
        text: "What other development mentioned shortly afterwards would make a simple planning-caused-growth explanation less convincing?",
        options: [
          "The decline of the fishing industry.",
          "The construction of Madrid's office towers.",
          "The arrival of package tourism and improved air access.",
          "The growth of Scandinavian department stores."
        ],
        correct: 2
      }
    ],
  ...
  scene4_retry: {
    type: "text",
    text: `
The trap is causality.

Two things happening in sequence does not necessarily mean that one,
by itself, caused the other.

Planning matters.

So may transport, financing, consumer demand, marketing, regulation,
international tourism and wider economic conditions.

Try the section again with that distinction in mind.
    `,
    choices: [
      {
        text: "Reassess the evidence",
        next: "scene5"
      }
    ]
  },
  ...
  // ---------------------------------------------------------
  // SCENE 5 — FIRST LANGUAGE ACTIVATION
  // ---------------------------------------------------------
...
"The planning reform caused the increase in tourism."

Build a more defensible professional version.
    `,
  ...
  scene6: {
    type: "video-multi-question",
    youtube: "https://www.youtube.com/watch?v=5JrE1_K-m-s&t=816s",

    text: `
WATCH 13:36–16:59

This time, watch Benidorm as though it were a business model.
...
At what point can a strength become a vulnerability?
    `,
    ...
    questions: [
      {
        text: "What concentration risk does the video identify?",
        options: [
          "A heavy reliance on one major source market: British tourism.",
          "Dependence on one hotel operator.",
          "Reliance on residential purchasers from Madrid.",
          "Dependence on one airline."
        ],
        correct: 0
      },
      {
        text: "Why is the water crisis particularly interesting from a risk perspective?",
        options: [
          "It was entirely unpredictable.",
          "It exposed an underlying constraint that growth had not eliminated.",
          "It demonstrated that tourism demand had disappeared.",
          "It was caused primarily by poor hotel accounting."
        ],
        correct: 1
      },
      {
        text: "Which description best captures the eventual response?",
        options: [
          "The underlying risk disappeared permanently.",
          "Demand was deliberately reduced to match the available water.",
          "The region developed infrastructure and shared capacity to mitigate the exposure.",
          "Hotels became individually responsible for sourcing all water."
        ],
        correct: 2
      },
      {
        text: "What is the most useful audit question after controls have been introduced?",
        options: [
          "Has the original risk ceased to exist?",
          "Who first identified the problem?",
          "How much did tourism grow afterwards?",
          "To what extent has the control reduced the exposure, and what residual risk remains?"
        ],
        correct: 3
      }
    ],
...
RISK does not necessarily mean FAILURE.

A risk may exist for years without crystallising.

And a control does not necessarily remove the underlying exposure.

Watch again and separate:

1. the underlying vulnerability;
2. the event that exposed it;
3. the mitigation subsequently introduced.
    `,
    choices: [
      {
        text: "Watch again",
  ...
  // ---------------------------------------------------------
  // SCENE 7 — VIDEO 4
  // INTEMPO — REAL ESTATE / FINANCING
  // ---------------------------------------------------------

  scene7: {
    type: "video-multi-question",
    youtube: "https://www.youtube.com/watch?v=5JrE1_K-m-s&t=1023s",

    text: `
WATCH 17:03–19:06

Now the story moves directly into real estate.

Imagine that it is 2007 rather than today.

Property prices are rising.
A landmark tower is under construction.
Financing is available.
The market remains optimistic.

You are reviewing the project before the crisis occurs.
    `,
    ...
    questions: [
      {
        text: "Which issue would deserve particular attention even before any actual default occurred?",
        options: [
          "The architectural shape of the tower.",
          "The extent to which the project's viability depended on continued favourable market conditions.",
          "Whether the tower would become a local landmark.",
          "Whether newspapers liked the design."
        ],
        correct: 1
      },
      {
        text: "What happened after the financial crisis struck?",
        options: [
          "The project was immediately sold at a profit.",
          "The tower was converted into a hotel.",
          "The financing deteriorated, the original developer failed and construction stopped.",
          "The municipality took direct ownership of the tower."
        ],
        correct: 2
      },
      {
        text: "The video mentions a 92-million-euro loan going bad. Which audit area does that most directly bring into the discussion?",
        options: [
          "Credit and recoverability risk.",
          "Brand identity.",
      ...
      {
        text: "Which conclusion goes beyond the evidence presented in the extract?",
        options: [
          "The project was exposed to a major deterioration in Spanish property conditions.",
          "The original developer ultimately entered bankruptcy.",
          "The project experienced a severe financing and completion problem.",
          "Management knowingly concealed the project's financial position from lenders."
        ],
        correct: 3
      }
    ],
  ...
  scene7_retry: {
    type: "text",
    text: `
Be careful not to use hindsight as evidence.

Knowing that a project eventually failed does not prove that fraud,
concealment or negligence occurred beforehand.

The useful question is:

"What indicators would have justified greater scrutiny at the time?"

Try again.
    `,
    choices: [
      {
        text: "Review the case again",
        next: "scene7"
      }
    ]
  },
  ...
  // ---------------------------------------------------------
  // SCENE 8 — CONVERSATIONAL AUDIT DEBRIEF
  // ---------------------------------------------------------

  scene8: {
    type: "text",
    text: `
Imagine somebody summarises the entire story like this:

"Benidorm took huge risks, but everything worked out in the end."
...
• effective controls;
• and simply surviving an adverse event.

Discuss:

Which of the risks in the story would concern you most if you were reviewing
a real-estate portfolio exposed to a tourism-dependent coastal market?

Then continue to the Grammar Run.
    `,
    choices: [
      {
...
"The project depended too much on prices continuing to rise."
    `,
...
Build the cautious audit formulation.
    `,
...
"Occupancy is strong, but this doesn't prove the model is resilient."
    `,
  ...
  // ---------------------------------------------------------
  // GRAMMAR 4 — PROFESSIONAL QUESTIONING
  // ---------------------------------------------------------
...
Build a formulation that avoids overstating causality.
    `,
...
"Benidorm's extraordinary growth proves that the development model
was fundamentally sound."

You have around 60–90 seconds.

Try to use at least THREE of these structures naturally:
...
• it would be worth establishing whether...
• cannot necessarily be attributed to...

Do not turn it into an audit report.

Answer as you would in a conversation with another senior professional.
    `,
    choices: [
      {
        text: "Finish Week 1",
...
One idea to carry into the next discussion:

A convincing explanation is not necessarily a wrong explanation.

But the more convincing it sounds,
the easier it can be to stop asking what supports it.
    `
  }
